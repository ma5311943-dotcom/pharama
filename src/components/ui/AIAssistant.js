      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="mb-3 w-[370px] h-[600px] lg:w-[440px] lg:h-[500px] bg-bg-card/95 backdrop-blur-2xl rounded-3xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.25)] border border-border-nav/60 flex flex-col overflow-hidden"
          >
